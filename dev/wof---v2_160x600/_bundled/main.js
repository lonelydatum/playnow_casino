...
// import {wof_v2} from '../../_common/js/wof.js'

function start() {

	var list = ["#take_1 .flip-card-inner", "#take_2 .flip-card-inner", "#take_3 .flip-card-inner", "#take_4 .flip-card-inner", "#it_1 .flip-card-inner", "#it_2 .flip-card-inner", "#anytime_6 .flip-card-inner", "#anytime_7 .flip-card-inner", "#for_1 .flip-card-inner", "#for_2 .flip-card-inner", "#for_3 .flip-card-inner", "#a_1 .flip-card-inner", "#like_2 .flip-card-inner", "#like_3 .flip-card-inner", "#like_4 .flip-card-inner", "#spin_1 .flip-card-inner", "#spin_2 .flip-card-inner", "#spin_3 .flip-card-inner", "#spin_4 .flip-card-inner"];
