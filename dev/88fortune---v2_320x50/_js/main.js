...
function group1(){
	...
	tl.add(coinItem(".coin_a", 180, 3), .1)
	tl.add(coinItem(".coin_b", 160, 3), .3)
	tl.add(coinItem(".coin_c", 190, 3), .5)
	tl.add(coinItem(".coin_d", 230, 3), .7)
}
...
function group2(){
	...
	tl.add(coinItem(".coin_c", 230, 2), "t2+=.3")
