...
function group1() {
	...
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_a", 350, 3), "t2+=.1");
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_b", 400, 3), "t2+=.2");
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_c", 500, 3), "t2+=.3");
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_d", 600, 3), "t2+=.4");
}

function group2() {
	var tl = new TimelineMax();
	tl.add("t2", 3.2);
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_a", 450, 3), "t2+=.1");
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_b", 510, 3), "t2+=.2");
	tl.add((0, _commonJsCommonJs.coinItem)(".coin_c", 560, 3), "t2+=.3");
}
